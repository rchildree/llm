...
export function imperfectActiveEnding(person: Person, number: LatinNumber): string {
  const endings: Record<LatinNumber, Record<Person, string>> = {
    sg: { "1": "am", "2": "ās", "3": "at" },
...
export function imperfectPassiveEnding(person: Person, number: LatinNumber): string {
  const endings: Record<LatinNumber, Record<Person, string>> = {
...
export function futurePassiveFirstSecondEnding(person: Person, number: LatinNumber): string {
  const endings: Record<LatinNumber, Record<Person, string>> = {
...
export function futurePerfectEnding(person: Person, number: LatinNumber): string {
  const endings: Record<LatinNumber, Record<Person, string>> = {
